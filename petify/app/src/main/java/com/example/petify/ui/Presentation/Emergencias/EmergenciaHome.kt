...
fun EmergenciaHome(
    ...
    val emergenciaItems= remember { mutableStateOf(vm.emergenciaItems.toList()) }
    LaunchedEffect(key1 = text.value ){
        if(text.value!=""){
            emergenciaItems.value = vm.emergenciaItems.filter { servicio->
                servicio.titulo!!.lowercase().contains(text.value.lowercase())
            }
        }else{
            emergenciaItems.value = vm.emergenciaItems
        }
    }
    ...
    Box(
        ...
        LazyColumn(modifier= Modifier.fillMaxWidth(0.9f),
            ...
            item{
                Card(
                    ...
                    Box(modifier= Modifier.fillMaxSize()){
                        Image(painter = painterResource(id = R.drawable.emergenciabanner),modifier= Modifier.fillMaxSize(), contentDescription = "banner",
            ...
            itemsIndexed(emergenciaItems.value){ index, servicio->
                if (index!=0){
                            ...
                            Column(
                                ...
                                Row(
                                    ...
                                    Row(
                                        ...
                                        Text(text=servicio.horario.toString(),modifier=Modifier.fillMaxWidth(0.3f), fontSize = 12.sp, overflow = TextOverflow.Ellipsis, maxLines = 1)
                                    }
